...
nuget Be.Vlaanderen.Basisregisters.Build.Pipeline 6.0.0 //"
...
Target.create "Lib_Build" (fun _ ->
  buildSource "Be.Vlaanderen.Basisregisters.Utilities.ToStringBuilder"
  buildTest "Be.Vlaanderen.Basisregisters.Utilities.ToStringBuilder.Tests"
)

Target.create "Lib_Test" (fun _ ->
  [
    "test" @@ "Be.Vlaanderen.Basisregisters.Utilities.ToStringBuilder.Tests" ]
  |> List.iter testWithDotNet
)

Target.create "Lib_Publish" (fun _ -> publishSource "Be.Vlaanderen.Basisregisters.Utilities.ToStringBuilder")
